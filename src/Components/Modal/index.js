...
const Modal = ({ isVisible, toggleModal, title, children}) => {
  return (
    <MaterialModal
        ...
        <img src={modalWave} className='servoModal__wave' alt='Servo Modal Top Wave' />
          <div className='servoModal__closeButtonWrapper'>
            <IconButton size='small'>
              <Close className='servoModal__closeIcon' fontSize="inherit" />
            </IconButton>
          </div>
          <div className='servoModal__body'>
            <h2 style={{fontSize: '1.65rem'}} className='primaryGradientText'>{title}</h2>
            {children}
          </div>
...
Modal.defaultProps = {
  ...
  primaryActionOnClick: () => console.log('primaryActionOnClick function not declared.'),
  primaryActionIcon: null,
  secondaryActionName: null,
  secondaryActionOnClick: () => console.log('secondaryActionOnClick function not declared.'),
